...
import intializeAuthentication from "../Pages/Login/Login/Firebase/firebase.init";
...
const useFirebase = () => {
    ...
    useEffect(() => {
        fetch(`https://obscure-reaches-98124.herokuapp.com/users/${user.email}`)
            .then(res => res.json())
    ...
    const saveUser = (email, displayName, method) => {
        ...
        fetch('https://obscure-reaches-98124.herokuapp.com/users', {
            method: method,
            headers: {
